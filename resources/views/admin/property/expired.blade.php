        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Список истекших объявлений</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Главная</a></li>
                            <li class="breadcrumb-item active">Истекший</li>
                        </ol>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('expired.property.search')}}" role="form" class="row">
                                {{ csrf_field() }}
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group has-info">
                                        <select class="form-control custom-select" name="velayat" id="velayat_select">
                ...
                @if(count($properties))
                    @foreach($properties as $property)
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <img class="card-img-top" src="/{{$property->img}}" alt="Card image cap">
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-12">
                                            <h4 class="text-primary">&#36; {{$property->price}} {{$property->saleOrRent ? "" : "/в мес."}}</h4>
                                        </div>    
                                        
                                        <div class="col-md-4 col-sm-12">
                                            <form action="{{route('property.return.expired', ['id' => $property->id, 'type' => 1])}}" method="post">
                                                {{ csrf_field() }}
                                ...
                                <div class="card-body border-top">
                                    <div class="d-flex no-block align-items-center">
                                        ...
                                        <span class="p-10 text-muted">Rooms</span>
                                        <span class="ml-auto badge badge-pill badge-secondary pull-right">{{$property->rooms}}</span>
                                    </div>
                                    <div class="d-flex no-block align-items-center">
