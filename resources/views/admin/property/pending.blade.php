        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Список ожидающих объявлений</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Главная</a></li>
                            <li class="breadcrumb-item active">В ожидании</li>
                        </ol>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('pending.property.search')}}" class="row" role="form">
                                {{ csrf_field() }}
                                ...
                                <div class="card-body bg-light" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <a href="{{route('property.return.accepted', ['id' => $property->id])}}" class="btn btn-info float-right"><i class="fa fa-lg fa-check-circle"></i></a>
