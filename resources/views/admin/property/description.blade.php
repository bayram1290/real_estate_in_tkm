        ...
        <div class="container-fluid">
            <div class="text_ar">
                ...
                @if($property->accepted)
                    <a href="{{route('property.return.pending', ['id' => $property->id])}}" title="Suspend" class="btn btn-info float-right description_btn">
                        Отменить объявление
                    </a>
                @else
                    <div class="col-md-4 col-sm-12">
                        <a href="{{route('property.return.accepted', ['id' => $property->id])}}" class="btn btn-info float-right">
