...
@endif
@if(!is_null($property->building_type_id) || !is_null($property->building_area) || !is_null($property->land_area) || !is_null($property->ventilation_id) || !is_null($property->conditioning_id) || !is_null($property->heating_id) || !is_null($property->firefighting_id) || !is_null($property->from_dusk_till_dawn) || (!is_null($property->from_hour) && !is_null($property->to_hour)) || !is_null($property->day_week_id))
    <br>
    <div class="basic_information m-b-20">
