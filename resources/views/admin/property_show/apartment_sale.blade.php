...
@endif
@if(!is_null($property->village_name) || !is_null($property->construction_year) || !is_null($property->type_property_id) || (!is_null($property->passenger_elevator) && (int)$property->passenger_elevator != 0) || (!is_null($property->service_elevator) && (int)$property->service_elevator != 0) || !is_null($property->parking_id))
    <br>
    <div class="basic_information m-b-20">
