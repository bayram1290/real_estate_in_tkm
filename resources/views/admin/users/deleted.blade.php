                                    ...
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-icon btn-success btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="Restore">
                                                        <a style="color: #0b0b0b" href="{{route('admin.user.restore',['id' => $user->id])}}"><i class="ti-plus" aria-hidden="true"></i></a></button>
                                                </td>
                                                <td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <a href="{{route('admin.user.create')}}" class="btn btn-info btn-rounded">Добавить пользователя</a>
                                            </td>
