<form action="{{route('property.submit')}}" method="post" class="submit_form" enctype="multipart/form-data">
    ...
    <div class="prod_kott propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            <label for="pdom_tot_rooms" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.num_rooms')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <select name="tot_rooms" id="pdom_tot_rooms" class="form-control white_form selectpicker" required>
        ...
        <div class="form-group row">
            <label for="pkott_total_floor1"
                   class="col-lg-4 col-md-3 col-sm-4 form-label1"
                   required>{{__('messages.total_floor1')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number"
                       min="1"
                       max="10"
        ...
        <label for="pkott_land_area" class="col-lg-4 col-md-3 col-sm-4 col-xs-12 form-label1 p-r-0">{{__('messages.land_area')}}<i class="fa fa-certificate s_req"></i></label>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-7 p-r-0 norm_g">
                <input type="number"
                       min="0.01"
                       max="200"
                       class="form-control white_form cusBorRad3"
                       id="pkott_land_area"
                       name="lArea" 
                       step="0.01" 
                       required />
        ...
        {{--<div class="upload_media">--}}
            ...
            {{--<div class="row">--}}
                {{--<div class="col-md-12">--}}
                    {{--<div class="browse_submit" id="fileupload12" style="position: relative">--}}
                        {{--<input name="img[]"--}}
                               {{--type="file"--}}
                               {{--id="fileupload-example-12"--}}
                               {{--class="img_upload12"--}}
                               {{--multiple--}}
                               {{--required/>--}}
                        {{--<label class="fileupload-example-label"--}}
                               {{--id="label12"--}}
                               {{--for="fileupload-example-12">{{__('messages.click_for_upload')}}</label>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-20 m_m-r-0">
                <input type="number" min="1" class="form-control price_input" id="pkott_price" name="price" step="0.1" required />
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 t_p-r-0 dec_btns m_m-b-0 b_agent" id="pkott_bonus_agent" data-toggle="buttons">
                ...
                @foreach($bonus_agents as $bonus_agent)
                    <label class="btn btn-primary {{$bonus_agent->id == 1 ? 'cusBorRad1 active' : ''}}{{$bonus_agent->id == 3 ? 'cusBorRad2' : ''}}">
                        <input type="radio"
                               name="bonus_agent"
                               value="{{$bonus_agent->id}}" {{$bonus_agent->id == 1 ? 'checked':''}}>@if(Lang::locale() == 'ru') {{$bonus_agent->bonus_ru}}
        ...
        <div class="property_owner">
            ...
            <div class="browse_submit">
                <button name="submit" onclick="return empty(event, 9)" class="btn btn-default">{{__('messages.submit')}}</button>
