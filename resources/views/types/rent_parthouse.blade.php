    ...
    <div class="ar_poldom propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 ubuyk_g" id="poldom_n_settlement">
                <input type="text" name="n_settlement" class="form-control white_form">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" name="const_year" id="kott_const_year" class="form-control white_form" min="1900" max="{{ now()->year }}">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" class="form-control white_form" id="poldom_tot_area" name="tot_area" step="0.01" required />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="text" name="rent_part"  id="poldom_rent_part"
                       class="form-control white_form" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="1" max="10" class="form-control white_form" name="tot_floor" id="poldom_tot_floor">
            </div>
        </div>
        <div class="form-group row">
            <label for="poldom_num_beds" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.num_beds')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="0" max="20" class="form-control white_form" id="poldom_num_beds" name="num_beds">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-5 p-l-0 nkuck_g">
                <select name="land_unit" class="form-control selectpicker cusBorRad5 white_form">
                    @foreach($land_area_types as $land_area_type)
                        <option value="{{$land_area_type->id}}">@if(Lang::locale() == 'ru') {{$land_area_type->type_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns1" id="poldom_comm_payment" data-toggle="buttons">
                <label class="btn btn-primary cusBorRad1 active">
                    <input type="radio" name="comm_payment" value="1" checked>{{__('messages.incl_yes')}}</label>
                <label class="btn btn-primary cusBorRad2">
                    <input type="radio" name="comm_payment" value="0">{{__('messages.incl_no')}}</label>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns1" id="poldom_rent_period" data-toggle="buttons">
                @foreach($rent_terms as $rent_term)
                    <label class="btn btn-primary {{$rent_term->id == 1 ? 'cusBorRad1' : 'cusBorRad2'}} {{$rent_term->term == 1 ? 'active' : ''}}">
                        <input type="radio" name="rent_period" value="{{$rent_term->id}}">@if(Lang::locale() == 'ru') {{$rent_term->term_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select4" class="form-control velayat_select white_form selectpicker m-b-0"
                        required>
        ...
        <div class="form-group row">
            <label for="poldom_address" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.address')}}<i
                        class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_3" name="address"
                       placeholder="{{__('messages.street_holder')}}" requried>
        ...
        <div class="property_owner">
            ...
            <div class="browse_submit">
                <button name="submit" onclick="return empty(event, 3)" class="btn btn-default">{{__('messages.submit')}}</button>
