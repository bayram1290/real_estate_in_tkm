    ...
    <div class="ar_kott propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 ubuyk_g">
                <input type="text" class="form-control white_form" name="n_settlement" id="kott_n_settlement">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" name="tot_area" id="kott_tot_area" class="form-control white_form" step="0.01" required />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="1" max="10" class="form-control white_form" name="tot_floor" id="kott_tot_floor" />
            </div>
        </div>
        <div class="form-group row">
            <label for="kott_num_beds" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.num_beds')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="0" max="20" class="form-control white_form" name="num_beds" id="kott_num_beds">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns2" id="kott_bath" data-toggle="buttons">
                @foreach($bathrooms as $bathroom)
                    <label for="bath" class="btn btn-primary {{$bathroom->id == 1 ? 'cusBorRad1' : ''}} {{$bathroom->id == 3 ? 'cusBorRad2' : ''}}">
        ...
        <label for="kott_land_area" class="col-lg-4 col-md-3 col-sm-4 col-xs-12 form-label1 p-r-0">{{__('messages.land_area')}}<i class="fa fa-certificate s_req"></i></label>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-7 p-r-0 norm_g">
                <input type="number" min="0.01" max="200" class="form-control white_form cusBorRad3" id="kott_land_area" name="lArea" step="0.01" required />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g fly_mob3 m-r-20 m_m-r-0">
                <input type="number" min="1" class="form-control price_input" name="price" step="0.01" required/>
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns1" id="kott_rent_period" data-toggle="buttons">
                @foreach($rent_terms as $rent_term)
                    <label class="btn btn-primary {{$rent_term->id == 1 ? 'cusBorRad1' : 'cusBorRad2'}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <select class="form-control white_form selectpicker" name="prepayment" id="kott_prepayment">
                    <option value="-1" selected disabled style="display:none">{{__('messages.no_select')}}</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <input type="number" name="own_deposit" id="kot_own_deposit"
                       class="form-control white_form" min="0" step="0.01" />
