    ...
    <div class="prod_ofis propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" name="tot_area" id="pofis_area" class="form-control white_form" step="0.01" required />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" min="1" max="100" class="form-control white_form m_m-b-5" name="floor" id="pofis_floor" data-dcheck="1" step="1" pattern="\d+" required />
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="0.3" max="10" class="form-control white_form" name="ceil" id="pofis_ceil_height" step="0.01" />
            </div>
        ...
        <div class="form-group row hide">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 ubuyk_g" id="occ_per_pofis">
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns t_m-b-20" id="pofis_layout" data-toggle="buttons">
                @foreach($office_repairs as $office_repair)
                    <label class="btn btn-primary {{$office_repair->id == 1 ? 'cusBorRad1' :''}} {{$office_repair->id == 4 ? 'cusBorRad2' :''}}">
                        <input type="radio" name="layout" value="{{$office_repair->id}}">@if(Lang::locale() == 'ru') {{$office_repair->repair_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="1" max="5000" class="form-control white_form" name="elec_pow" id="pofis_elec_pow">
            </div>
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns" id="pofis_parking" data-toggle="buttons">
                @foreach($parkings as $parking)
                    @if($parking->id != 3 && $parking->id != 4)
                        <label id="sale_office" class="btn btn-primary {{$parking->id == 1 ? 'cusBorRad1' : ''}} {{$parking->id == 5 ? 'cusBorRad2' : ''}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g fly_mob5">
                <input type="number" min="0.5" max="1500" class="form-control white_form m_m-b-5" id="pofis_entry_cost" name="cost" step="0.1" />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" class="form-control white_form" id="pofis_a_build" name="a_build" step="0.01" />
            </div>
            <span class="cSpan fly_mob2">{{__('messages.meter')}}<sup>2</sup></span>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="0.01" max="200" class="form-control white_form m_m-b-5" id="pofis_land" name="lArea" step="0.01" />
            </div>
            <span class="cSpan fly_mob2">{{__('messages.ga')}}
                <span class="anwrap m-l-20 land_opts m_hide">
                    ...
                    <label class="radOn w-auto"><input type="radio" name="land_type" value="{{$land_owning_type->id}}" {{$land_owning_type->id == 1 ? 'checked':''}}><span class="outer"><span class="inner"></span></span>@if(Lang::locale() == 'ru') {{$land_owning_type->type_ru}}
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 h_inBen">
                <div class="col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="vent_4" name="vent_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="cond_4" name="cond_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="heat_4" name="heat_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="fextin_4" name="fextin_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-20 m_m-r-0">
                <input type="number" min="1" class="form-control price_input" id="pofis_price" name="price" step="0.1" required />
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 t_p-r-0 dec_btns b_agent m_m-b-0" id="pofis_bonus_agent" data-toggle="buttons">
                ...
                @foreach($bonus_agents as $bonus_agent)
                    <label class="btn btn-primary {{$bonus_agent->id == 1 ? 'cusBorRad1 active' : '' }} {{$bonus_agent->id == 3 ? 'cusBorRad2' : '' }}">
                        <input type="radio" name="bonus_agent" value="{{$bonus_agent->id}}" {{$bonus_agent->id == 1 ? 'checked=checked':''}}>@if(Lang::locale() == 'ru') {{$bonus_agent->bonus_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select14" class="form-control velayat_select white_form selectpicker m-b-0" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="city" id="city_select_14" class="form-control white_form selectpicker m-b-0" required>
                    <option selected disabled class="hide">{{__('messages.no_select')}}</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_14" name="address" placeholder="{{__('messages.street_holder')}}" required />
