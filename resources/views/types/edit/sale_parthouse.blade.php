    ...
    <div class="prod_poldom propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 ubuyk_g">
                <input type="text" class="form-control white_form" id="ppdom_n_settlement" name="n_settlement" value="{{ $property->village_name }}" />
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" min="1900" max="{{ now()->year }}" class="form-control white_form" id="ppdom_const_year" name="const_year" value="{{$property->construction_year > 0 ? $property->construction_year : ''}}" />
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="text" class="form-control white_form" id="ppdom_share_size" name="rent_part" value="{{$property->rent_part > 0 ? $property->rent_part : ''}}" required />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" name="tot_area" id="ppdom_tot_area" class="form-control white_form" step="0.01" value="{{ $property->area }}" required />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="1" max="10" class="form-control white_form" name="tot_floor" id="ppdom_total_floor1" value="{{ $property->floors_in_home > 0 ? $property->floors_in_home : '' }}" required />
            </div>
        </div>
        <div class="form-group row">
            <label for="ppdom_num_beds" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.num_beds')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="0" max="20" class="form-control white_form" name="num_beds" id="ppdom_num_beds" value="{{ $property->num_beds > 0 ? $property->num_beds : '' }}" />
            </div>
        </div>
        <div class="form-group row">
        ...
        <label for="ppdom_land_area" class="col-lg-4 col-md-3 col-sm-4 col-xs-12 form-label1 p-r-0">{{__('messages.land_area')}}<i class="fa fa-certificate s_req"></i></label>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-7 p-r-0 norm_g">
                <input type="number" min="0.01" max="200" class="form-control white_form cusBorRad3" id="ppdom_land_area" name="lArea" step="0.01" value="{{$property->land_area > 0 ? $property->land_area : ''}}" required />
        ...
        <input type="hidden" name="mainImg" id="mainImg_13" value="{{$property->img}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-20 m_m-r-0">
                <input type="number" min="1" class="form-control price_input" id="ppdom_price" name="price" step="0.1" value="{{$property->price}}" required/>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select13" class="form-control velayat_select white_form selectpicker m-b-36" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_13" name="address" placeholder="{{__('messages.street_holder')}}" value="{{$property->address}}" required />
        ...
        <div class="property_owner">
            ...
            <div class="browse_submit">
                <button name="submit" onclick="return empty(event, 10)" class="btn btn-default">{{__('messages.save_changes')}}</button>
