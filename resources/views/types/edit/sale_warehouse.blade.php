<form action="{{route('property.resubmit', ['id' => $property->id])}}" method="post" class="submit_form" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="prod_sklad propObj {{$hide ? 'hide' : ''}}">
        <div class="basic_information">
            <h4 class="inner-title">{{__('messages.ob_property')}}</h4>
        </div>
        <div class="form-group row">
            <label for="psklad_area" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.area')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" name="tot_area" id="psklad_area" class="form-control white_form" step="0.01" value="{{$property->area}}" required />
        ...
        <div class="form-group row">
            <label for="psklad_in_parts" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.in_parts')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="psklad_in_parts" data-toggle="buttons">
        ...
        <div class="form-group row">
            <label for="psklad_floor" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.floor')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" min="1" max="99" class="form-control white_form m_m-b-5" name="floor" id="psklad_floor" data-dcheck="1" step="1" pattern="\d+" value="{{$property->floor > 0 ? $property->floor : ''}}" required />
            </div>
        ...
        <div class="form-group row">
            <label for="psklad_leg_add" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.leg_add')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <select name="leg_add" id="psklad_leg_add" class="form-control white_form selectpicker">
        ...
        <div class="form-group row">
            <label for="psklad_ceil_height" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.ceil_height')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="0.3" max="10" class="form-control white_form" name="ceil" id="psklad_ceil_height" step="0.01" value="{{$property->ceil_height > 0 ? $property->ceil_height : ''}}" />
            </div>
            <span class="cSpan fly_mob2">{{__('messages.meter')}}</span>
        </div>
        <div class="form-group row">
            <label for="psklad_col_grid" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.col_grid')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="text" class="form-control white_form" name="grid" id="psklad_col_grid" placeholder="{{__('messages.col_grid_holder')}}" value="{{ $property->column_grid }}"/>
            </div>
        </div>
        <div class="form-group row">
            <label for="psklad_floor_mat" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.floor_mat')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <select name="floor_mat" id="psklad_floor_mat" class="form-control white_form selectpicker">
        ...
        <div class="form-group row">
            <label for="psklad_condition" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.condition')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <select name="cond" id="psklad_condition" class="form-control white_form selectpicker">
        ...
        <div class="form-group row">
            <label for="psklad_ent_gate" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.ent_gate')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <select name="ent_gate" id="psklad_ent_gate" class="form-control white_form selectpicker">
        ...
        <div class="form-group row">
            <label for="psklad_lifts" class="col-lg-4 col-md-3 col-sm-4 form-label1 text-capitalize">{{__('messages.elevs')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8" id="psklad_lifts">
            ...
            <div class="col-lg-offset-4 col-md-offset-3 col-sm-offset-4 col-lg-8 col-md-9 col-sm-8">
                <div class="col-lg-4 col-md-4 col-sm-6 p-l-0 m-r-10 t_m-r-0">
                    ...
                    <div class="pull-right ukuck_g m-r-5 t_unmax_f-right t_m-r-0 t_w-100">
                        <input type="number" min="0" max="100" class="form-control white_form m_m-b-10" name="telpher" value="{{ $property->warehouse_telfer_elev }}"></div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 m_p-l-0">
                    <span class="kuck_g cusSpan1 pull-left t_w-100">{{__('messages.lift_cap')}}:</span>
                    <div class="kuck_g pull-left m-r-10 t_unmax_f-right t_m-r-0 t_p-l-0 t_w-100 m_w-90">
            ...
            <div class="col-lg-offset-4 col-md-offset-3 col-sm-offset-4 col-lg-8 col-md-9 col-sm-8">
                <div class="col-lg-4 col-md-4 col-sm-6 p-l-0 m-r-10 t_m-r-0">
                    ...
                    <div class="pull-right ukuck_g m-r-5 t_unmax_f-right t_m-r-0 t_w-100">
                        <input type="number" min="0" max="100" class="form-control white_form m_m-b-10" name="passenger" value="{{ $property->warehouse_passenger_elev > 0 ? $property->warehouse_passenger_elev : '' }}"></div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 m_p-l-0">
                    <span class="kuck_g cusSpan1 pull-left t_w-100">{{__('messages.lift_cap')}}:</span>
                    <div class="kuck_g pull-left m-r-10 t_unmax_f-right t_m-r-0 t_p-l-0 t_w-100 m_w-90">
                        <input type="number" min="0" max="5" class="form-control white_form m_m-b-40" name="passenger_cap" step="0.01" value="{{ $property->warehouse_passenger_elev_cc > 0 ? $property->warehouse_passenger_elev_cc : '' }}" /></div>
                    <span class="cSpan ton_txt">{{__('messages.ton')}}</span>
                </div>
            </div>
        </div><br>
        <div class="form-group row">
            <label for="psklad_crane" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.crane_equip')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8" id="psklad_crane">
            ...
            <div class="col-lg-offset-4 col-md-offset-3 col-sm-offset-4 col-lg-8 col-md-9 col-sm-8">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 m_p-l-0">
                    <span class="kuck_g cusSpan1 pull-left t_w-100">{{__('messages.lift_cap')}}:</span>
                    <div class="kuck_g pull-left m-r-10 t_unmax_f-right t_m-r-0 t_p-l-0 t_w-100 m_w-90">
                        <input type="number" min="0" max="250" class="form-control white_form m_m-b-40" name="cr_rail_cap" step="0.01" value="{{ $property->warehouse_rail_crane_cc }}" /></div>
                    <span class="cSpan ton_txt">{{__('messages.ton')}}</span>
                </div>
            </div>
            <div class="col-lg-offset-4 col-md-offset-3 col-sm-offset-4 col-lg-8 col-md-9 col-sm-8">
        ...
        <div class="form-group row">
            <label for="psklad_elec_pow" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.elec_pow')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="1" max="5000" class="form-control white_form" name="elec_pow" id="psklad_elec_pow" value="{{$property->electric_power > 0 ? $property->electric_power : ''}}" />
            </div><span class="cSpan fly_mob2">{{__('messages.kW')}}</span>
        </div>
        <div class="form-group row">
            <label for="psklad_parking" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.parking')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns2" id="psklad_parking" data-toggle="buttons">
        ...
        <div class="form-group row">
            <label for="psklad_parking_type" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.parking_type')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns" id="psklad_parking_type" data-toggle="buttons">
        ...
        <div class="form-group row">
            <label for="psklad_place_num" class="col-lg-4 col-md-3 col-sm-4 form-label1 dCol_txt">{{__('messages.place_num')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="1" max="1000" class="form-control white_form" id="psklad_place_num" name="place_num" value="{{$property->parking_spots > 0 ? $property->parking_spots : ''}}" />
            </div>
        </div>
        <div class="form-group row">
            <label for="psklad_entry_cost" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.entry_cost')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-5 fly_mob5 m_m-r-0">
                <input type="number" min="1" max="1500" class="form-control white_form m_m-b-5" id="psklad_entry_cost" name="cost" step="0.1" value="{{ $property->parking_price !== 0 ? $property->parking_price : '' }}" {{!is_null($property->parking_price) && $property->parking_price == 0 ? 'disabled=disabled' : '' }} />
        ...
        <div class="form-group row">
            <label for="psklad_t_build" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.t_build')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 nbuyk_g">
                <select name="t_build" id="psklad_t_build" class="form-control white_form selectpicker">
                    <option selected disabled class="hide" {{ is_null($property->building_type_id) ? 'selected' : ''}}>{{__('messages.poss_appoint_holder')}}</option>
        ...
        <div class="form-group row">
            <label for="psklad_a_build" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.a_build')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" class="form-control white_form" id="psklad_a_build" name="a_build" step="0.01" value="{{$property->building_area}}" />
            </div><span class="cSpan fly_mob2">{{__('messages.meter')}}<sup>2</sup></span>
        </div>
        <div class="form-group row">
            <label for="psklad_land" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.land')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="0.01" max="200" class="form-control white_form t_m-b-10 m_m-b-5" id="psklad_land" name="lArea" step="0.01" value="{{$property->land_area > 0 ? $property->land_area : ''}}" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 h_inBen">
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="vent_8" name="vent_opt" value="1" {{ $property->ventilation_id ? 'checked' :''}}>
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="cond_8" name="cond_opt" value="1" {{$property->conditioning_id ? 'checked' :''}}>
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="heat_8" name="heat_opt" value="1" {{ $property->heating_id ? 'checked' :''}}>
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="fextin_8" name="fextin_opt" value="1" {{$property->firefighting_id ? 'checked' :''}}>
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
        ...
        <input type="hidden" name="mainImg" id="mainImg_18" value="{{$property->img}}">
        @foreach($property->image as $img)
            <input type="hidden" id="{{$img->name}}"
                   value="{{$img->name}}" name="img[]">
        @endforeach
        <div id="drag_18" class="drag-and-drop-zone dm-uploader p-5 text-center">
        ...
        <div class="form-group row">
            <label for="psklad_price" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.price')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-20 m_m-r-0">
                <input type="number" min="1" class="form-control price_input" id="psklad_price" name="price" step="0.1" value="{{$property->price}}" required />
        ...
        <div class="form-group row">
            <label for="psklad_tax" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.tax')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 nbuyk_g">
                <select name="tax" id="psklad_tax" class="form-control white_form selectpicker">
        ...
        <div class="form-group row">
            <label for="psklad_bonus_agent" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.bonus_agent')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 t_p-r-0 dec_btns m_m-b-0 b_agent" id="psklad_bonus_agent" data-toggle="buttons">
        ...
        <div class="form-group row">
            <label for="velayat_select18" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.velayat')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select18" class="form-control velayat_select white_form selectpicker m-b-36" required>
        ...
        <div class="form-group row">
            <label for="city_select_18" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.district')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="city" id="city_select_18" class="form-control white_form selectpicker m-b-0" required>
        ...
        <div class="form-group row">
            <label for="psklad_address" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.address')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_18" name="address" placeholder="{{__('messages.street_holder')}}" value="{{$property->address}}" required />
                <div class="sel_err_feed sel_err_invis">{{ __('messages.form_feed8') }}</div>
            </div>
        </div>
        <br>
        <div class="form-group row">
            <label for="map_18" class="col-lg-4 col-md-3 col-sm-4 form-label1 m-b-10">{{__('messages.map_loc')}}</label>            
        </div>
        <div id="map_18" class="myMap"></div>        
        <div class="property_owner">
            <input type="hidden" id="lat_18" name="lat_18">
            <input type="hidden" id="lng_18" name="lng_18">
