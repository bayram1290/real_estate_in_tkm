    ...
    <div class="ar_dom propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 ubuyk_g">
                <input type="text" name="n_settlement" id="dom_n_settlement" class="form-control white_form" value="{{$property->village_name}}">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" name="const_year" id="dom_const_year" class="form-control white_form" min="1900" max="{{ now()->year }}" value="{{$property->construction_year}}">
            </div>
        </div>
        <div class="form-group row">
            <label for="dom_t_house" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('message.t_house')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-9 buyk_g">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" class="form-control white_form" id="dom_tot_area" name="tot_area" step="0.01" value="{{$property->area}}" required/>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="1" max="10" class="form-control white_form" name="tot_floor" id="dom_floor_house" value="{{$property->floors_in_home > 0 ? $property->floors_in_home : '' }}" />
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g" id="num_beds">
                <input type="number" min="0" max="20" class="form-control white_form" id="dom_num_beds" name="num_beds" value="{{$property->num_beds > 0 ? $property->num_beds : '' }}" />
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns2" id="dom_bath" data-toggle="buttons">
                @foreach($bathrooms as $bathroom)
                    <label class="btn btn-primary {{$bathroom->id == 1 ? 'cusBorRad1' : ''}} {{$bathroom->id == 3 ? 'cusBorRad2' : ''}} {{$property->bathroom_id == $bathroom->id ? 'active' : ''}}">
                        <input type="radio" name="bath" value="{{$bathroom->id}}" {{$property->bathroom_id == $bathroom->id ? 'checked' : ''}}>@if(Lang::locale() == 'ru') {{$bathroom->bathroom_ru}}
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns" id="dom_decor" data-toggle="buttons">
                @foreach($revamps as $revamp)
                    <label class="btn btn-primary {{$revamp->id == 1 ? 'cusBorRad1' :''}} {{$revamp->id == 4 ? 'cusBorRad2' :''}} {{$property->revamp_id == $revamp->id ? 'active' : ''}}">
                        <input type="radio" name="decor" value="{{$revamp->id}}" {{$property->revamp_id == $revamp->id ? 'checked=checked' : ''}}>@if(Lang::locale() == 'ru') {{$revamp->type_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-7 p-r-0 norm_g">
                <input type="number" min="0.01" max="200" class="form-control cusBorRad3 white_form" step="0.01" id="dom_land_area" name="lArea" value="{{$property->land_area}}" required />
        ...
        <input type="hidden" name="mainImg" id="mainImg_2" value="{{$property->img}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g fly_mob3 m-r-20 m_m-r-0">
                <input type="number" min="1" class="form-control price_input" id="dom_price" name="price" step="0.1" value="{{$property->price}}" required/>
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns1" id="dom_comm_payment" data-toggle="buttons">
                <label for="comm_payment" class="btn btn-primary cusBorRad1 {{$property->comm_payment_included ? 'active' : ''}}">
                    <input type="radio" name="comm_payment" value="1" {{$property->comm_payment_included ? 'checked=checked' : ''}}> {{__('messages.incl_yes')}}
                </label>
                <label class="btn btn-primary cusBorRad2 {{ (!is_null($property->comm_payment_included) && !$property->comm_payment_included) ? 'active' : ''}}">
                    <input type="radio" name="comm_payment" value="0" {{(!is_null($property->comm_payment_included) && !$property->comm_payment_included) ? 'checked=checked' : ''}}>  {{__('messages.incl_no')}}
                </label>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <input type="number" name="own_deposit"  id="dom_own_deposit" class="form-control white_form" min="0" step="0.1" value="{{$property->deposit_payment > 0 ? $property->deposit_payment : ''}}" />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select2" class="form-control velayat_select white_form selectpicker m-b-36" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_2" name="address" placeholder="{{__('messages.street_holder')}}" value="{{$property->address}}" required />
