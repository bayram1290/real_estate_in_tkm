<form action="{{route('property.resubmit', ['id' => $property->id])}}" method="post" class="submit_form" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="prod_kott propObj {{$hide ? 'hide' : ''}}">  
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 ubuyk_g">
                <input type="text" class="form-control white_form" id="pdom_n_settlement" name="n_settlement" value="{{ $property->village_name }}" />
            </div>
        </div>
        <div class="form-group row">
            <label for="pkott_const_year" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.const_year')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" min="1900" max="{{ now()->year }}" class="form-control white_form" id="pkott_const_year" name="const_year" value="{{$property->construction_year > 0 ? $property->construction_year : '' }}" />
            </div>
        </div>
        <div class="form-group row">
            <label for="pkott_t_house" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.t_house')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <select name="t_house" id="pkott_t_house" class="form-control white_form selectpicker">
        ...
        <div class="form-group row">
            <label for="pkot_tot_rooms" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.num_rooms')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <select name="tot_rooms" id="pkot_tot_rooms" class="form-control white_form selectpicker" required>
        ...
        <div class="form-group row">
            <label for="pkott_tot_area" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.tot_area')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" name="tot_area" id="pkott_tot_area" class="form-control white_form" step="0.01" value="{{ $property->value }}" required />
        ...
        <div class="form-group row">
            <label for="pkott_total_floor1" class="col-lg-4 col-md-3 col-sm-4 form-label1" required>{{__('messages.total_floor1')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="1" max="10" class="form-control white_form" name="tot_floor" id="pkott_total_floor1" value="{{ $property->floors_in_home > 0 ? $property->floors_in_home : '' }}" required />
            </div>
        </div>
        <div class="form-group row">
            <label for="pkott_num_beds" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.num_beds')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
                <input type="number" min="0" max="20" class="form-control white_form" name="num_beds" id="pkott_num_beds" value="{{ $property->num_beds > 0 ? $property->num_beds : '' }}" />
            </div>
        </div>
        <div class="form-group row">
            <label for="pkott_bath" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.bath')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns2" id="pkott_bath" data-toggle="buttons">
        ...
        <div class="form-group row">
            <label for="pkott_heating" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.heating_system')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <select name="heating" id="pkott_heating" class="form-control white_form selectpicker">
        ...
        <br>
        <div class="form-group row">
            <label for="pkott_addition" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.addition')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8" id="pkott_addition">
        ...
        <br>
        <div class="form-group row">
        <label for="pkott_land_area" class="col-lg-4 col-md-3 col-sm-4 col-xs-12 form-label1 p-r-0">{{__('messages.land_area')}}<i class="fa fa-certificate s_req"></i></label>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-7 p-r-0 norm_g">
                <input type="number" min="0.01" max="200" class="form-control white_form cusBorRad3" id="pkott_land_area" name="lArea" step="0.01" value="{{$property->land_area > 0 ? $property->land_area : ''}}" required />
        ...
        <div class="form-group row">
            <label for="pkott_land_status" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.land_status')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <select name="land_status" id="pkott_land_status" class="form-control white_form selectpicker" required>
                    @foreach($land_statuses as $land_status)
                        <option value="{{$land_status->id}}" {{ $property->land_status_id == $land_status->id ? 'selected' : '' }}>@if(Lang::locale() == 'ru') {{$land_status->status_ru}}
        ...
        <input type="hidden" name="mainImg" id="mainImg_12" value="{{$property->img}}">
        @foreach($property->image as $img)
            <input type="hidden" id="{{$img->name}}"
                   value="{{$img->name}}" name="img[]">
        @endforeach
        <div id="drag_12" class="drag-and-drop-zone dm-uploader p-5 text-center">
        ...
        <div class="form-group row">
            <label for="pkott_price" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.price')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-20 m_m-r-0">
                <input type="number" min="1"  class="form-control price_input" id="pkott_price" name="price" step="0.1" value="{{$property->price}}" required/>
        ...
        <div class="form-group row">
            <label for="pkott_bonus_agent" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.bonus_agent')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 t_p-r-0 dec_btns m_m-b-0 b_agent" id="pkott_bonus_agent" data-toggle="buttons">
        ...
        <div class="form-group row">
            <label for="velayat_select12" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.velayat')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select12" class="form-control velayat_select white_form selectpicker m-b-36" required>
        ...
        <div class="form-group row">
            <label for="city_select_12" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.district')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="city" id="city_select_12" class="form-control white_form selectpicker m-b-0" required>
        ...
        <div class="form-group row">
            <label for="pkott_address" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.address')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_12" name="address" placeholder="{{__('messages.street_holder')}}" value="{{$property->address}}" required />
                <div class="sel_err_feed sel_err_invis">{{ __('messages.form_feed8') }}</div>
            </div>
        </div>
        <br>
        <div class="form-group row">
            <label for="map_12" class="col-lg-4 col-md-3 col-sm-4 form-label1 m-b-10">{{__('messages.map_loc')}}</label>            
        </div>
        <div id="map_12" class="myMap"></div>
        <br>
        <div class="property_owner">
            <input type="hidden" id="lat_12" name="lat_12">
            <input type="hidden" id="lng_12" name="lng_12">
            ...
            <div class="browse_submit">
                <button name="submit" onclick="return empty(event, 9)" class="btn btn-default">{{__('messages.save_changes')}}</button>
