<form action="{{route('property.submit')}}" method="post" class="submit_form" enctype="multipart/form-data">
    ...
    <div class="ar_kv propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            <label for="kv_tot_rooms" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.num_rooms')}}<i
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" class="form-control white_form" id="kv_tot_area" name="tot_area" step="0.01" required />
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" min="1" max="99" class="form-control white_form" name="floor" id="kv_floor" required/>
        ...
        <div class="form-group row">
            <label for="kv_tot_floor" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.total_floor')}}<i 
                        class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" min="2" max="100" class="form-control white_form" name="tot_floor" id="kv_tot_floor" required />
        ...
        <div class="form-group row">
            <label for="kv_resid" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.residential')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" max="200" class="form-control white_form" name="resid" id="kv_resid" step="0.01" />
            </div>
            <span class="cSpan fly_mob2">{{__('messages.meter')}}<sup>2</sup></span>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" max="200" class="form-control white_form" name="kitchen" id="kv_kitchen" step="0.01" />
            </div>
            <span class="cSpan fly_mob2">{{__('messages.meter')}}<sup>2</sup></span>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="0.3" max="10" class="form-control white_form" name="ceil" id="kv_ceil" step="0.01"/>
            </div>
                ...
                @foreach($revamps as $revamp)
                    <label class="btn btn-primary {{$revamp->id == 1 ? 'cusBorRad1' :''}} {{$revamp->id == 4 ? 'cusBorRad2' :''}} {{$revamp->id == 1 ? 'active' : ''}}">
                        <input type="radio" name="decor"
                               value="{{$revamp->id}}" {{$revamp->id == 1 ? 'checked="checked"' : ''}}">@if(Lang::locale() == 'ru') {{$revamp->type_ru}}
        ...
        <br>
        <div class="form-group row">
            <label for="kv_with_animal" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.with_animal')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="kv_with_animal" data-toggle="buttons">
                <label class="btn btn-primary cusBorRad1">
                    <input type="radio" name="with_animal" value="1">
                    {{__('messages.yes')}}
                </label>
                <label class="btn btn-primary cusBorRad2">
                    <input type="radio" name="with_animal"
                           value="0">{{__('messages.no')}}
                </label>
            </div>
        </div>
        <div class="form-group row">
            <label for="kv_with_child" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.with_child')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="kv_with_child" data-toggle="buttons">
                <label class="btn btn-primary cusBorRad1">
                    <input type="radio" name="with_child" value="1">{{__('messages.yes')}}
                </label>
                <label class="btn btn-primary cusBorRad2">
                    <input type="radio" name="with_child" value="0">{{__('messages.no')}}
                </label>
            </div>
        </div>
        <div class="form-group row">
            <label for="kv_for_family" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.for_family')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="kv_for_family" data-toggle="buttons">
                <label class="btn btn-primary cusBorRad1">
                    <input type="radio" name="for_family" value="1">{{__('messages.yes')}}
                </label>
                <label class="btn btn-primary cusBorRad2">
                    <input type="radio" name="for_family" value="0">{{__('messages.no')}}
                </label>
            </div>
        </div>
        <div class="form-group row">
            <label for="kv_for_single" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.for_single')}}</label>
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="kv_for_single" data-toggle="buttons">
                <label class="btn btn-primary cusBorRad1">
                    <input type="radio" name="for_single" value="1">{{__('messages.yes')}}
                </label>
                <label class="btn btn-primary cusBorRad2">
                    <input type="radio" name="for_single" value="0">{{__('messages.no')}}
                </label>
            </div>
        </div>
        <br>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" class="form-control white_form" id="kv_const_year" name="const_year" min="1900" max="{{ now()->year }}">
            </div>
        </div>        
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="kv_parking" data-toggle="buttons">
                @foreach($parkings as $parking)
                    @if($parking->id < 3)
                        <label for="parking" class="btn btn-primary {{$parking->id == 1 ? 'cusBorRad1' : 'cusBorRad2'}}">
        ...
        <br><br>
        <hr>
        <div id="description" class="description m-b-40">
            <div class="basic_information">
        ...
        <div class="form-group row">
            <label for="kv_price" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.rent_price')}}<i class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-20 m_m-r-0">
                <input type="number" min="1.0" class="form-control price_input" id="kv_price" name="price" step="0.1" required />
        ...
        <div class="form-group row">
            <label for="kv_own_deposit" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.own_deposit')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <input type="number" name="own_deposit" id="kv_own_deposit" class="form-control white_form t_m-b-10" step="0.1" min="1.0">
        ...
        <br>
        <div class="form-group row">
            <label for="tp_building" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.prepayment')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g">
        ...
        <div class="form-group row">
            <label for="velayat_select1" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.velayat')}}<i
                        class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select1" class="form-control velayat_select white_form selectpicker m-b-0"
                        required>
                    <option selected disabled class="hide">{{__('messages.no_select')}}</option>
        ...
        <div class="form-group row">
            <label for="city_select_1" class="col-lg-4 col-md-3 col-sm-4 form-label1 p-r-0">{{__('messages.district')}}<i
                        class="fa fa-certificate pull-right"></i></label>
            <div class="col-lg-8 col-md-9 col-sm-8">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_1" name="address"
                       placeholder="{{__('messages.street_holder')}}" required />
        ...
        <div class="property_owner">
            ...
            <div class="browse_submit">
                <button name="submit" onclick="return empty(event, 1)" class="btn btn-default">{{__('messages.submit')}}</button>
