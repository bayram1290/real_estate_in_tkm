    ...
    <div class="ar_ofis propObj {{$hide ? 'hide' : ''}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" name="tot_area" id="ofis_area" class="form-control white_form" step="0.01" required />
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="ofis_in_parts" data-toggle="buttons">
                <label for="in_parts" class="btn btn-primary cusBorRad1">
                    <input type="radio" name="in_parts" value="1">{{__('messages.yes')}}
                </label>
                <label for="in_parts" class="btn btn-primary cusBorRad2">
                    <input type="radio" name="in_parts" value="0">{{__('messages.no')}}
                </label>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g">
                <input type="number" min="1" ma="99" class="form-control white_form m_m-b-5" name="floor" data-dcheck="1" id="ofis_floor" step="1" pattern="\d+" required />
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="0.3" max="10" class="form-control white_form" name="ceil" id="ofis_ceil_height" step="0.01" />
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="ofis_occ_room" data-toggle="buttons">
                <label class="btn btn-primary cusBorRad1">
                    <input type="radio" name="occ_room" value="1">{{__('messages.yes')}}
                </label>
                <label class="btn btn-primary cusBorRad2">
                    <input type="radio" name="occ_room" value="2">{{__('messages.no')}}
                </label>
            </div>
        </div>
        <div class="form-group row hide">
            <label for="occ_per_ofis" class="col-lg-4 col-md-3 col-sm-4 form-label1">{{__('messages.release_date')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 ubuyk_g" id="occ_per_ofis">
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns" id="ofis_layout" data-toggle="buttons">
                @foreach($office_repairs as $office_repair)
                    <label for="layout" class="btn btn-primary {{$office_repair->id == 1 ? 'cusBorRad1 active' :''}} {{$office_repair->id == 4 ? 'cusBorRad2' :''}}">
                        <input type="radio" name="layout" value="{{$office_repair->id}}" {{$office_repair->id == 1 ? 'checked=checked' :''}}>@if(Lang::locale() == 'ru') {{$office_repair->repair_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="1" max="5000" class="form-control white_form" name="elec_pow" id="ofis_elec_pow">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8" id="ofis_furniture" data-toggle="buttons">
                <label for="furniture" class="btn btn-primary cusBorRad1">
                    <input type="radio" name="furniture" value="1">{{__('messages.exist')}}
                </label>
                <label for="furniture" class="btn btn-primary cusBorRad2">
        ...
        <div class="form-group row">
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns1" id="ofis_entrance" data-toggle="buttons">
                @foreach($entrances as $entrance)
                    <label class="btn btn-primary {{$entrance->id == 1 ? 'cusBorRad1' : 'cusBorRad2'}}">
                        <input type="radio" name="entry" value="{{$entrance->id}}">@if(Lang::locale() == 'ru') {{$entrance->entrance_ru}}
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns" id="parking_wrap" data-toggle="buttons">
                @foreach($parkings as $parking)
                    @if($parking->id != 3 && $parking->id != 4)
                        <label id="rent_office" class="btn btn-primary {{$parking->id == 1 ? 'cusBorRad1' : ''}} {{$parking->id == 5 ? 'cusBorRad2' : ''}}">
        ...
        <div class="form-group row">
            <label for="ofis_place_num" id="first-rent_office" class="col-lg-4 col-md-3 col-sm-4 form-label1 dCol_txt">{{__('messages.place_num')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <input type="number" min="1" max="1000" class="form-control white_form" name="place_num" id="ofis_place_num">
            </div>
        </div>
        <div class="form-group row" id="ex_parking_spots_rent_office" style="display: none">
            <label for="ofis_place_num_ex" id="second-rent_office" class="col-lg-4 col-md-3 col-sm-4 form-label1 dCol_txt">{{__('messages.place_num')}}</label>
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g fly_mob5">
                <input type="number" min="0.5" max="1500" class="form-control white_form m_m-b-5" name="cost" id="ofis_cost" step="0.1" />
            ...
            <span class="cSpan dCol fly_mob6 m_m-b-5 pretCusFont">{{__('messages.for_month')}}
                <div class="pretty p-icon p-curve p-pulse en_free_wrap m_hide m-l-50">
                    <input type="checkbox" name="entry_free" value="0">
            ...
            <span class="col-xs-8 m-t-10 m-b-20 m_show pretCusFont">
                <div class="pretty p-icon p-curve p-pulse en_free_wrap">
                    <input type="checkbox" name="entry_free1" value="0">
                    <div class="state p-primary-o">
                        <i class="icon fa fa-check" aria-hidden="true"></i>
                        <label>{{__('messages.free')}}</label>
                    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="1" class="form-control white_form" id="ofis_a_build" name="a_build" step="0.01" />
            </div>
            <span class="cSpan fly_mob2">{{__('messages.meter')}}<sup>2</sup></span>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 norm_g fly_mob1">
                <input type="number" min="0.01" max="200" class="form-control white_form m_m-b-5" id="ofis_land" name="lArea" step="0.01" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 h_inBen">
                <div class="col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="vent_0" name="vent_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                    ...
                    @foreach($ventilation as $vent)
                        <label class="radOn">
                            <input type="radio" name="vent_type" value="{{$vent->id}}"><span class="outer"><span class="inner"></span></span>@if(Lang::locale() == 'ru') {{$vent->ventilation_ru}}
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="cond_0" name="cond_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="heat_0" name="heat_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-6 anwrap m_p-l-0 pretCusFont">
                    <div class="pretty p-icon p-curve p-pulse m-l-10 m-b-15">
                        <input type="checkbox" id="fextin_0" name="fextin_opt" value="1">
                        <div class="state p-primary-o">
                            <i class="icon fa fa-check" aria-hidden="true"></i>
        ...
        <div class="form-group row">            
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g m-r-20 m_m-r-0">
                <input type="number" min="1" class="form-control price_input" name="price" step="0.1" required />
            ...
            <span class="anwrap m-l-20 pr_per">
                @foreach($periods as $period)
                    <label class="radOn w-auto m_m-r-20">
                        <input type="radio" name="for_period" value="{{$period->id}}" {{$period->id == 1 ? 'checked':''}}>
                        <span class="outer">
                            <span class="inner"></span>
                        </span>@if(Lang::locale() == 'ru') {{$period->period_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 btn-group toGGle dec_btns1 m_m-b-50" id="ofis_rent_type" data-toggle="buttons">
                @foreach($rent_types as $rent_type)
                    <label class="btn btn-primary {{$rent_type->id == 1 ? 'cusBorRad1' : 'cusBorRad2'}} {{$rent_type->term == 1 ? 'active' : ''}}" required>
                        <input type="radio" name="rent_type"  value="{{$rent_type->id}}">@if(Lang::locale() == 'ru') {{$rent_type->type_ru}}
            ...
            <div class="btn-group toGGle col-lg-8 col-md-9 col-sm-8 dec_btns1" id="ofis_rent_period" data-toggle="buttons">
                @foreach($rent_terms as $rent_term)
                    <label class="btn btn-primary {{$rent_term->id == 1 ? 'cusBorRad1 active' : 'cusBorRad2'}}">
                        <input type="radio" name="rent_period" value="{{$rent_term->id}}" {{$rent_term->id == 1 ? 'checked=checked' : ''}}>@if(Lang::locale() == 'ru') {{$rent_term->term_ru}}
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 kuck_g fly_mob1">
                <input type="number" min="0" max="120" class="form-control white_form" name="min_rent" id="ofis_min_per_rent" />
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8 buyk_g">
                <input type="number" min="0" class="form-control white_form" id="ofis_sec_deposit" name="own_deposit" step="0.1" />
                <span class="cSpan1">TMT</span>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <select name="velayat" id="velayat_select5" class="form-control velayat_select white_form selectpicker m-b-0" required>
                    <option selected disabled class="hide">{{__('messages.no_select')}}</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-8 col-md-9 col-sm-8">
                <input type="text" class="form-control white_form m-b-0" id="address_4" name="address" placeholder="{{__('messages.street_holder')}}" required />
